...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI() // prints "PART TIME EMPLOYEE" because emp3 is a clone of pEmp1, which is a part time employee.
		// emp3.getHourlyRate(); // returns syntax error because no hourly rate variable exists in employee.

		// TODO To complete
		// Add the condition that test that emp3 is an instance of part time employee at
		// this time
		//if (emp3.getClass().getName() == "PartTimeEmployee") {
		...
		// TODO To complete
		// This instruction compiles / does not compile - This code does not compile.
		// This instruction returns a ClassCastException at run time
		// because ... an Employee class cannot downcast correctly to PartTime Employee
